...
class TestRestApiUrlsGaraze:
    ...
    def test_lista_svih_garaza_url_autorizovan_korisnik(self,
        ...
        * @see conftest.py (novi_autorizovan_korisnik_fixture_garaze)
        ...
        print("\n")
        print('############################')
        print(f' BROJ GARAZA: {broj_garaza_u_bazi}')
        print(f' broj_kupaca_u_bazi: {broj_kupaca_u_bazi}')
    ...
    def test_kreiraj_garazu(self, client, nova_jedna_garaza_fixture):
        """
        ...
        print("\n")
        print('############################')
        print(f' GARAZA FIXTURE: {nova_jedna_garaza_fixture}')
        ...
        # print("\n")
        # print('############################')
        # print(f' BROJ GARAZA: {response.data}')
        #
