...
urlpatterns = [
    ...
    path('ponude-stana-meseci/<int:id_stana>', BrojPonudaStanovaPoMesecimaAPIView.as_view(),
         name='ponude-stana-meseci'),
    ...
    path('promeni-cenu-kvadrata/<int:id_azur_cene>', AzuriranjeCenaUpdateAPIView.as_view(),
         name='promeni-cenu-kvadrata'),
    # Brisanje mesecne cene kvadrata
    path('izbrisi-cenu-kvadrata/<int:id_azur_cene>', AzuriranjeCenaDeleteAPIView.as_view(),
         name='izbrisi-cenu-kvadrata')
]
